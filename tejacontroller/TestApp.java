...
import in.tejaservicefactory.StudentServiceFactory;
...
public class TestApp {
	...
	public static void main(String[] args) throws Exception {
		...
		while (true) {
			...
			System.out.print("PERFORM CRUD OPERATION(Note:refer above options) PRESS[1/2/3/4/5]::  ");
